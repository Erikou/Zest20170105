...
class RightsController extends Controller
{
	public function indexAction()
	{
        ...
        $listAbilitations = $em->getRepository('SEInputBundle:Abilitation')->getAll();
        $listPermissions = $em->getRepository('SEInputBundle:Permission')->getAll();
        $em->flush();
        
		return $this->render('SEAdminBundle:Admin:rights.html.twig', array(
            'listUsers' => $listUsers,
			'listAbilitations' => $listAbilitations,
